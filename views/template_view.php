    ...
    <body>
        ...
        <?php
            ...
            if(!isset($_SERVER['PATH_INFO'])){
                ...
                if(file_exists('E:/xampp/htdocs/System_of_electronic_document_circulation/views/views/'.basename($_SERVER['PATH_INFO']).'_view.php')){
                    include 'E:/xampp/htdocs/System_of_electronic_document_circulation/views/views/'.basename($_SERVER['PATH_INFO']).'_view.php';
                }
                else{
                    echo '404';echo basename($_SERVER['PATH_INFO']);
                }
            }
